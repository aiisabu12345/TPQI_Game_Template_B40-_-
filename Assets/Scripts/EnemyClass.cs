...
public class EnemyClass : MonoBehaviour
{
    ...
    void Update()
    {
        //ถ้ายังไม่ได้ถูกยิง และ มีtarget จะเคลื่อนที่ไปหาtarget ด้วยความเร็ว = speed
    ...
    {
        //ถ้ายังไม่ได้ถูกยิง และ ชนกับgameobject ที่มีtag bullet จะ เพิ่มscore,Updateว่าถูกยิงแล้ว และ เรียกใช้FlashRedAndDestroy
    ...
    private IEnumerator FlashRedAndDestroy()
    {
        ...
        //กระพิบเ็นสีแดงสลับขาว ก่อนDestroy
